...
# ============================================================
# PASSO 4: CARREGAR OS PDFS QUE SERAO CONSULTADOS
# ============================================================
#
# Aqui carregamos varios arquivos PDF que servirao como base de conhecimento.
#
# Em um sistema RAG, esse conjunto de documentos funciona como a fonte de informacao
...
# em trechos reais dos arquivos carregados.
#
# Neste exemplo, cada PDF representa um tipo de cartao diferente:
# - Standard
# - Gold
# - Platinum
#
# O PyPDFLoader le o conteudo de cada PDF e o transforma em uma lista de
# documentos do LangChain, normalmente uma entrada por pagina.
#
# Depois, juntamos todas essas listas em uma unica colecao chamada
# "documentos", que sera usada nas proximas etapas do RAG.
arquivos = [
...
# ============================================================
# PASSO 5: DIVIDIR OS DOCUMENTOS EM PEDACOS MENORES
# ============================================================
#
# Depois de carregar todos os PDFs, dividimos o conteudo em pequenos trechos
# chamados chunks.
#
...
#
# Mesmo tendo varios PDFs, depois desta etapa o sistema passa a trabalhar
# com uma unica colecao de pedacos. Ou seja, para a busca vetorial,
# nao importa muito de qual arquivo original o trecho veio:
# todos entram no mesmo indice.
...
# ============================================================
#
# Agora pegamos os pedacos vindos de todos os PDFs e transformamos cada um em embedding.
...
# "Quais trechos, entre todos os PDFs carregados, mais se parecem com esta pergunta?"
#
...
# mais relevantes entre todos os documentos indexados.
#
# k=2 significa:
...
# 1. busca os trechos mais relevantes entre todos os PDFs
# 2. monta o contexto
# 3. envia a pergunta + contexto para o modelo
# 4. devolve a resposta final
def responder(pergunta: str):
    # Busca os trechos que fazem mais sentido para a pergunta dentro
    # de toda a base vetorial formada pelos PDFs carregados.
...
# - ler varios PDFs
# - criar uma base unica com o conteudo desses arquivos
# - buscar os trechos mais relevantes nessa base consolidada
# - enviar esses trechos ao modelo
# - imprimir a resposta final
print(responder("Como devo precedorer caso tenha um ítem compado roubado roubado e caso eu tenha um cartão gold?"))
